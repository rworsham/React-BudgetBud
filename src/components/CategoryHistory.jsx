    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            ...
            try {
                ...
                const response = await api.post('/category/history/', dataPayload, {
                ...
                if (downloadPdf) {
                    ...
                    link.download = 'category_history_report.pdf';
                    link.click();
                    setIsLoading(false);
        ...
        fetchTransactions();
    }, [authTokens, startDate, endDate, category_id, downloadPdf, familyView]);
